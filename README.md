# Football Stats App (starter)

This is a minimal Next.js + TypeScript starter scaffold created by the AI assistant so you have a runnable app to iterate on.
...
- `package.json` — scripts to run/build the app

Next steps:
- Replace placeholder API with real football stats data source
- Add tests, linting rules, and CI workflow
